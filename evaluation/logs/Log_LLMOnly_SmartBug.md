PS E:\DarkHotel-CapstoneProject\DarkHotel-CapstoneProject\Capstone_FPT\DarkHotel-Capstone\evaluation> python run_llm_only_zeroshot.py --dataset smartbugs
======================================================================
...
======================================================================
ZERO-SHOT LLM-ONLY — SmartBugs-Curated (Vulnerable Contracts)
Prompt: Raw code only. No SWC hints, no checklist, no expert rules.
======================================================================
...
[21/98] etherbank.sol
  Expected: VULNERABLE (Reentrancy — SWC-107)
  Predicted: VULNERABLE | TP | 21.7s
    - Reentrancy (SWC-107)

[22/98] etherstore.sol
  Expected: VULNERABLE (Reentrancy — SWC-107)
  Predicted: VULNERABLE | TP | 20.5s
    - Reentrancy (SWC-107)

[23/98] modifier_reentrancy.sol
  Expected: VULNERABLE (Reentrancy — SWC-107)
  Predicted: VULNERABLE | TP | 28.1s
    - Reentrancy (SWC-107)

[24/98] reentrance.sol
  Expected: VULNERABLE (Reentrancy — SWC-107)
  Predicted: VULNERABLE | TP | 34.3s
    - Reentrancy (SWC-107)

[25/98] reentrancy_bonus.sol
  Expected: VULNERABLE (Reentrancy — SWC-107)
  Predicted: VULNERABLE | TP | 19.8s
    - Reentrancy (SWC-107)

[26/98] reentrancy_cross_function.sol
  Expected: VULNERABLE (Reentrancy — SWC-107)
  Predicted: VULNERABLE | TP | 22.8s
    - Reentrancy (SWC-107)
    - Integer Overflow/Underflow (SWC-101)

[27/98] reentrancy_dao.sol
  Expected: VULNERABLE (Reentrancy — SWC-107)
  Predicted: VULNERABLE | TP | 34.2s
    - Reentrancy (SWC-107)
    - Integer Overflow/Underflow (SWC-101)

[28/98] reentrancy_insecure.sol
  Expected: VULNERABLE (Reentrancy — SWC-107)
  Predicted: VULNERABLE | TP | 16.8s
    - Reentrancy (SWC-107)
...
[30/98] simple_dao.sol
  Expected: VULNERABLE (Reentrancy — SWC-107)
  Predicted: VULNERABLE | TP | 24.0s
    - Reentrancy (SWC-107)
    - Unchecked Return Value (SWC-104)

[31/98] spank_chain_payment.sol
  Expected: VULNERABLE (Reentrancy — SWC-107)
  Predicted: VULNERABLE | TP | 54.5s
    - Reentrancy (SWC-107)
    - Integer Overflow/Underflow (SWC-101)
    - Unchecked Return Value (SWC-104)

[32/98] BECToken.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 25.2s
    - Integer Overflow (SWC-101)

[33/98] insecure_transfer.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 18.1s
    - Integer Overflow (SWC-101)

[34/98] integer_overflow_1.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 16.1s
    - Integer Overflow (SWC-101)

[35/98] integer_overflow_add.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 15.1s
    - Integer Overflow (SWC-101)

[36/98] integer_overflow_benign_1.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 17.0s
    - Integer Overflow/Underflow (SWC-101)

[37/98] integer_overflow_mapping_sym_1.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 16.7s
    - Integer Overflow/Underflow (SWC-101)

[38/98] integer_overflow_minimal.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 15.7s
    - Integer Overflow/Underflow (SWC-101)

[39/98] integer_overflow_mul.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 14.3s
    - Integer Overflow (SWC-101)

[40/98] integer_overflow_multitx_multifunc_feasible.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 15.3s
    - Integer Overflow/Underflow (SWC-101)

[41/98] integer_overflow_multitx_onefunc_feasible.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 14.1s
    - Integer Overflow/Underflow (SWC-101)

[42/98] overflow_simple_add.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 13.2s
    - Integer Overflow (SWC-101)
...
[44/98] timelock.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 23.8s
    - Integer Overflow/Underflow (SWC-101)

[45/98] token.sol
  Expected: VULNERABLE (Integer Overflow/Underflow — SWC-101)
  Predicted: VULNERABLE | TP | 23.2s
    - Integer Overflow/Underflow (SWC-101)
...
[47/98] 0x07f7ecb66d788ab01dc93b9b71a88401de7d0f2e.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 44.6s
    - Unchecked Return Value (SWC-104)
    - Unchecked Return Value (SWC-104)

[48/98] 0x0cbe050f75bc8f8c2d6c0d249fea125fd6e1acc9.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 17.2s
    - Unchecked Return Value (SWC-104)

[49/98] 0x19cf8481ea15427a98ba3cdd6d9e14690011ab10.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 55.0s
    - Unchecked Return Value (SWC-104)
    - Unchecked Return Value (SWC-104)
    - Integer Overflow (SWC-101)
...
[50/98] 0x2972d548497286d18e92b5fa1f8f9139e5653fd2.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 18.6s
    - Unchecked Return Value (SWC-104)

[51/98] 0x39cfd754c85023648bf003bea2dd498c5612abfa.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 49.5s
    - Reentrancy (SWC-107)
    - Unchecked Return Value (SWC-104)
    - Integer Overflow (SWC-101)
...
[72/98] 0x958a8f594101d2c0485a52319f29b2647f2ebc06.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 43.0s
    - Unchecked Return Value (SWC-104)
    - Reentrancy (SWC-107)

[73/98] 0x9d06cbafa865037a01d322d3f4222fa3e04e5488.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 33.4s
    - Unchecked Return Value (SWC-104)
    - Unchecked Return Value (SWC-104)
    - Integer Overflow/Underflow (SWC-101)
...
[76/98] 0xb0510d68f210b7db66e8c7c814f22680f2b8d1d6.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 24.7s
    - Unchecked Return Value (SWC-104)
    - Unchecked Return Value (SWC-104)

[77/98] 0xb11b2fed6c9354f7aa2f658d3b4d7b31d8a13b77.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 27.6s
    - Unchecked Return Value (SWC-104)
    - Integer Overflow (SWC-101)
...
[82/98] 0xbebbfe5b549f5db6e6c78ca97cac19d1fb03082c.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 27.7s
    - Unchecked Return Value (SWC-104)
    - Integer Overflow (SWC-101)

[83/98] 0xd2018bfaa266a9ec0a1a84b061640faa009def76.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 52.1s
    - Unchecked Return Value (SWC-104)
...
[85/98] 0xdb1c55f6926e7d847ddf8678905ad871a68199d2.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 24.8s
    - Unchecked Return Value (SWC-104)

[86/98] 0xe09b1ab8111c2729a76f16de96bc86a7af837928.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 45.6s
    - Unchecked Return Value (SWC-104)
    - Reentrancy (SWC-107)
    - Integer Overflow/Underflow (SWC-101)
...
[97/98] mishandled.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 13.9s
    - Unchecked Return Value (SWC-104)

[98/98] unchecked_return_value.sol
  Expected: VULNERABLE (Unchecked Return Value — SWC-104)
  Predicted: VULNERABLE | TP | 15.6s
    - Unchecked Return Value (SWC-104)

======================================================================
RESULTS — ZERO-SHOT LLM-ONLY on SmartBugs-Curated
======================================================================
...
Per-Type Recall:
  Integer Overflow/Underflow          (SWC-101): 15/15 = 100%, type match: 100%
  Unchecked Return Value              (SWC-104): 52/52 = 100%, type match: 100%
  Reentrancy                          (SWC-107): 31/31 = 100%, type match: 100%

Secondary Findings: 56 total, 41 verified, 15 false alarm

Avg time: 28.3s | Total: 51.1 min

Saved: E:\DarkHotel-CapstoneProject\DarkHotel-CapstoneProject\Capstone_FPT\DarkHotel-Capstone\evaluation\llm_zeroshot_results\zeroshot_smartbugs_results.json
